...
if (isset($_POST['action']) && $_POST['action'] === 'update_password') {
    ...
    if ($new_password !== $confirm_password) {
        ...
        // Securely update the password in bank_details
        $stmt_update = $con->prepare("UPDATE bank_details SET password = ? WHERE email = ?");
        ...
        if ($stmt_update->execute()) {
            ...
            unset($_SESSION['bank_can_update_password']);
            unset($_SESSION['bank_otp_email']);
            
            // Redirect to login after 3 seconds
            header("refresh:3;url=bank_login.php");
        } else {
...
<head>
    ...
    <style>
        /* (Using the same CSS as forgot_password_bank.php for consistency) */
        :root {
...
<body>
    <div class="form-container">
        ...
        <?php if (empty($success_message)): ?>
            <p class="subtitle">Create a new, strong password for your bank account.</p>
            <form action="update_password_bank.php" method="POST">
