...
<head>
    ...
    <title>Shopping Cart - Sylhet IT Shop</title>
    <style>
        :root {
    ...
    <div class="navbar">
        <div class="navbar-container">
            ...
            <ul class="navbar-links">
                <li><a href="customer_profile.php" class="nav-button">My Profile</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <form method="POST" id="checkoutForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="address-input-wrapper">
                                <input type="text" id="addr" name="addr" placeholder="Enter your full address" required>
                            </div>
                        </div>
